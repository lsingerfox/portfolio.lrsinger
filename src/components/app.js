...
import { faTrash, faSignOutAlt, faEdit, faTimesCircle, faCompactDisc, faPlusCircle } from "@fortawesome/free-solid-svg-icons";
...
library.add(faTrash, faSignOutAlt, faEdit, faTimesCircle, faCompactDisc, faPlusCircle);
